/* Load pokemon input data set into a relation pokemon_input */

pokemon_input = LOAD '/home/acadgild/pokemon_usecase/Pokemon.csv' USING PigStorage(',') AS(Sno:int,Name:chararray,Type1:chararray,Type2:chararray,Total:int,HP:int,Attack:int,Defense:int,SpAtk:int,SpDef:int,Speed:int);

STORE pokemon_input INTO '/home/acadgild/pig/output/pokemon_usecase/input';

/* Question 1: Find the list of players that have been selected in the qualifying round (DEFENCE>55).*/

selected_list = FILTER pokemon_input BY Defense > 55;
...
/*Question 3: Using random() generate random numbers for each Pokémon on the selected list.
 This will create a list1 containing Pokémon to be considered for fighting each other. */
...
/*Question 4: Using random() generate random numbers for each Pokémon on the selected list.
 This will create a list2 containing Pokémon to be considered for fighting each other. */
...
/*Question 5: Arrange the new list in a descending order according to a column randomly.
 This will give us consequently a layer arranged to pick the random list which 1st player will choose. */
...
/*Question 6: Arrange the new list in a descending order according to a column randomly.
 This will give us consequently a layer arranged to pick the random list which 2nd player will choose. */
